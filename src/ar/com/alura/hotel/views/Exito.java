...
public class Exito extends JDialog {
	...
	public Exito() {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(Exito.class.getResource("/aH-40px.png")));
		...
		setUndecorated(true);
		{
			...
			lblNewLabel.setIcon(new ImageIcon(Exito.class.getResource("/Ha-100px.png")));
